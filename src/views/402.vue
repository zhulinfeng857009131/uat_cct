<template>
  ...
  <div class="content-container">
    <div class="head-line">
      <img src="/static/error.svg" alt="" width="120">
    </div>
    <div class="subheader">
      用户没有权限-无法登陆</div>
    <div class="hr"></div>
    <div class="context">
      <p >您可以返回首页，或联系管理员 </p>
	    <p style="font-size: 15px;">倒计时<span style="color:orange">{{count}}</span>秒自动返回首页 </p>
    </div>
			<el-button type="primary" style="margin:50px auto" @click="openUrl" >点击返回首页</el-button>
  </div>
  </body>
</template>
