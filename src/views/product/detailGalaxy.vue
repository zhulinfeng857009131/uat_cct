  ...
  <div id="" style="min-width: 1300px;margin: 0 50px;">
    <div class="detail-top cl">
      <div class="fl detail-fl" style="width: 30%;height: 400px;">
        <template>
          <el-carousel :interval="5000" arrow="always">
            <el-carousel-item>
              <span><img class="pro-img" src="@/assets/img/solutionaddp.png" style="height: 200px;"></span>
            </el-carousel-item>
            <el-carousel-item>
              <span><img class="pro-img" src="@/assets/img/solutionaddp.png" style="height: 200px;"></span>
            </el-carousel-item>
      ...
      <div class="fr detail-fr" style="width: 69%;height: 400px;">
        <h2>Galaxy PX</h2>
        <p>
         作为施耐德电气全新一体化UPS供配电系统，Galaxy PX系列UPS具有模块化，占地空间小的特点，配备各类附件和选件，帮助您在严苛用电环境下为各类关键负载提供高性能电源保护。
        </p>
      </div>
    </div>
    <div class="detail-main">
      <el-menu default-active="1" class="el-menu-demo" mode="horizontal" @select="handleSelect">
        <el-menu-item index="1" style="width:25%">产品手册</el-menu-item>
        <el-menu-item index="3" style="width:25%">技术规格</el-menu-item>
        <el-menu-item index="4" style="width:25%">产品认证</el-menu-item>
        <!-- <el-menu-item index="5">产品案例</el-menu-item> -->
      ...
      <div style="padding: 20px 15px;">
        ...
        <template v-if="key == 3">
<img class="pro-img" src="@/assets/img/gpxend1.png" style="max-width: 100%;display: block;margin: 10px auto;">
...
import {
  ...
  export default {
    ...
    mounted: function() {
      var that = this;
      that.productList = [{
          img:'https://bang.schneider-electric.cn/pdp/cct/img/case1.jpg',
          imgc:'https://bang.schneider-electric.cn/pdp/cct/img/case1-con.jpg',
          name: '江苏烟草南通专卖配套项目'
        },
        {
        ...
        {
          img:'https://bang.schneider-electric.cn/pdp/cct/img/case3.jpg',
          imgc:'https://bang.schneider-electric.cn/pdp/cct/img/case3-con.jpg',
          name: '天津市理工大学机械设计学院边缘计算IMDC案例'
        },
        {
          img:'https://bang.schneider-electric.cn/pdp/cct/img/case4.jpg',
          imgc:'https://bang.schneider-electric.cn/pdp/cct/img/case4-con.jpg',
          name: '京东云'
        },
        {
          img:'https://bang.schneider-electric.cn/pdp/cct/img/case5.jpg',
          imgc:'https://bang.schneider-electric.cn/pdp/cct/img/case5-con.jpg',
          name: '上海海事局航标处项目'
        },
      ];
      ...
      that.tableData = [
        {
          fileName: 'Galaxy+PX+brochure_2020.09.23',
          url:'https://bang.schneider-electric.cn/pdp/cct/pdf/Galaxy+PX+brochure_2020.09.23.pdf',
          fileName:'Galaxy+PX+brochure_2020.09.23',
          date: '2020/01/05',
        }
      ]
      that.tableData1 = [
        {
          fileName: 'Glaxy+PX+100kVA+EMC+Test+Report_EMC',
          url:'https://bang.schneider-electric.cn/pdp/cct/pdf/Glaxy+PX+100kVA+EMC+Test+Report_EMC.pdf',
          fileName:'Glaxy+PX+100kVA+EMC+Test+Report_EMC',
          date: '2020/01/05',
        },
        {
          fileName: 'CERT-64.105.20.30084.01-CE',
          url:'https://bang.schneider-electric.cn/pdp/cct/pdf/CERT-64.105.20.30084.01-CE.pdf',
          fileName:'CERT-64.105.20.30084.01-CE',
          date: '2020/01/05',
        },
        {
          fileName: '62040-1+report',
          url:'https://bang.schneider-electric.cn/pdp/cct/pdf/62040-1+report.pdf',
          fileName:'62040-1+report',
          date: '2020/01/05',
        },
        {
          fileName: 'ISTA',
          url:'https://bang.schneider-electric.cn/pdp/cct/pdf/ISTA.pdf',
          fileName:'ISTA',
          date: '2020/01/05',
        }
      ]
